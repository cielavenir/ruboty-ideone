...
module Ruboty
	module Handlers
		class Ideone < Base
			LANGUAGES=[
	{:key=>"7", :value=>"Ada (gnat-5.1)"},
	{:key=>"45", :value=>"Assembler (gcc-5.1)"},
	{:key=>"13", :value=>"Assembler (nasm-2.11.05)"},
	{:key=>"104", :value=>"AWK (gawk) (gawk-4.1.1)"},
	{:key=>"105", :value=>"AWK (mawk) (mawk-3.3)"},
	{:key=>"28", :value=>"Bash (bash 4.3.33)"},
	{:key=>"110", :value=>"bc (bc-1.06.95)"},
	{:key=>"12", :value=>"Brainf**k (bff-1.0.5)"},
	{:key=>"81", :value=>"C (clang 3.7)"},
	{:key=>"11", :value=>"C (gcc-5.1)"},
	{:key=>"27", :value=>"C# (mono-4.0.2)"},
	{:key=>"82", :value=>"C++ (clang 3.7)"},
	{:key=>"41", :value=>"C++ 4.3.2 (gcc-4.3.2)"},
	{:key=>"1", :value=>"C++ 5.1 (gcc-5.1)"},
	{:key=>"44", :value=>"C++14 (gcc-5.1)"},
	{:key=>"34", :value=>"C99 strict (gcc-5.1)"},
	...
	{:key=>"91", :value=>"CoffeeScript (1.9.3)"},
	{:key=>"32", :value=>"Common Lisp (clisp) (clisp 2.49)"},
	{:key=>"84", :value=>"D (ldc 0.14)"},
	{:key=>"20", :value=>"D (gdc 5.1)"},
	{:key=>"102", :value=>"D (dmd) (dmd-2.067.1)"},
	{:key=>"96", :value=>"Elixir (1.1.0)"},
	{:key=>"36", :value=>"Erlang (erl-18)"},
	{:key=>"124", :value=>"F# (fsharp-3.1)"},
	{:key=>"123", :value=>"Factor (factor-0.93)"},
	{:key=>"125", :value=>"Falcon (falcon-0.9.6.6)"},
	{:key=>"92", :value=>"Fantom (1.0.67)"},
	{:key=>"107", :value=>"Forth (gforth-0.7.2)"},
	{:key=>"5", :value=>"Fortran (gfortran-5.1)"},
	{:key=>"114", :value=>"Go (1.4.2)"},
	{:key=>"121", :value=>"Groovy (groovy-2.4)"},
	{:key=>"21", :value=>"Haskell (ghc-7.8)"},
	{:key=>"16", :value=>"Icon (iconc 9.4.3)"},
	{:key=>"9", :value=>"Intercal (c-intercal 28.0-r1)"},
	{:key=>"10", :value=>"Java (sun-jdk-8u51)"},
	{:key=>"55", :value=>"Java7 (sun-jdk-1.7.0_10)"},
	{:key=>"35", :value=>"JavaScript (rhino) (rhino-1.7.7)"},
	...
	{:key=>"122", :value=>"Nim (0.11.2)"},
	{:key=>"56", :value=>"Node.js (0.12.7)"},
	{:key=>"83", :value=>"Objective-C (clang 3.7)"},
	{:key=>"43", :value=>"Objective-C (gcc-5.1)"},
